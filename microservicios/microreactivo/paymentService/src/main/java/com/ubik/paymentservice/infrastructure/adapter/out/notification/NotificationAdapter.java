...
public class NotificationAdapter {
    ...
    public NotificationAdapter(@Value("${services.notification-service.url:http://notification-service:8088}") String notificationUrl) {
    ...
    public Mono<Void> sendInvoiceEmail(String toEmail, String subject, String message, byte[] pdfAttachment, String attachmentName) {
        ...
        return webClient.post()
                .uri("/api/notifications/send") // Adjust to match actual path if needed
